...
* Each row and observation is a singular shot taken, contain information about 

* We select 19 variables for our analysis


```{r display-data, warning = FALSE, message = FALSE, echo = FALSE}
recent_season %>% slice_head(n = 5) %>% select(goal,shotType,shotGoalieFroze,awaySkatersOnIce,season,shotAngleAdjusted,xCordAdjusted,xGoal) %>% gt()
```

...
plot1 <- g + 
  stat_summary_hex(data = evenstrength,
                   ...
                   binwidth = c(3,3),
                   color = xg_logit_even$fitted.values,
                   fun = mean) +
...
plot2 <- g + 
  stat_summary_hex(data = evenstrength,
                   ...
                   binwidth = c(3,3),
                   color = reb_logit_even$fitted.values,
                   fun = mean) +
  scale_fill_gradient(low = "darkblue",
                      high = "darkorange") +
   ylim(25, 100) +
...
plot3 <- g + 
  stat_summary_hex(data = evenstrength,
                   ...
                   binwidth = c(3,3),
                   color = froze_logit_even$fitted.values,
                   fun = mean) +
  scale_fill_gradient(low = "darkblue",
                      high = "darkorange") +
...
plot4 <-
  ...
  stat_summary_hex(data = evenstrength,
                   ...
                   binwidth = c(3,3),
                   color = inZone_logit_even$fitted.values,
                   fun = mean) +
  scale_fill_gradient(low = "darkblue",
                      high = "darkorange")  +
...
plot5 <-g + 
  stat_summary_hex(data = evenstrength,
                   ...
                   binwidth = c(3,3),
                   color = outZone_logit_even$fitted.values,
                   fun = mean) +
  scale_fill_gradient(low = "darkblue",
                      high = "darkorange") +
...
plot6 <- g + 
  stat_summary_hex(data = evenstrength,
                   ...
                   binwidth = c(3,3),
                   color = stop_logit_even$fitted.values,
                   fun = mean) +
  scale_fill_gradient(low = "darkblue",
                      high = "darkorange") +
...
plot7 <-  g + 
  stat_summary_hex(data = evenstrength,
                   ...
                   binwidth = c(3,3),
                   color = shotOnGoal_logit_even$fitted.values,
                   fun = mean) +
  scale_fill_gradient(low = "darkblue",
                      high = "darkorange") +
...
>>>>>>> bee087d7e5c961b32318dcfb855a87f7161348a7

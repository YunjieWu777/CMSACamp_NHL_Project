...
# load("data/multi_coe.RData")


shots1019 <- as.data.frame(shots1019)
shots2020 <- as.data.frame(shots2020)

one <- dplyr::select(shots1019,
     ...
     "shotWasOnGoal", "xGoal", "shotPlayStopped", "shooterPlayerId", "goalieNameForShot", "shooterName", "goalieIdForShot")
two <- dplyr::select(shots2020,
      "shotGoalieFroze","shotPlayContinuedInZone",
      "shotPlayContinuedOutsideZone","season","shotAngleAdjusted",
      "arenaAdjustedShotDistance","goal","shotGeneratedRebound", 
      "xCordAdjusted", "yCordAdjusted", "shotAngle", "homeSkatersOnIce", 

...
## Flow Chart for Shots Missing Net
...
* Build 7 simple logistic regression models, one for each outcome and another one for weather the shot was on goal
...
```{r}
#Have a quick understnad about how each preditor influcen the outcome and then switch to multinomial approach
```

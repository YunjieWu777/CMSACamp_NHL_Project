...
knitr::include_graphics("simpleflowchart.png")
```
...
knitr::include_graphics("10minutepres_file/rink.png")
```
...
knitr::include_graphics("10minutepres_file/pl_all_heatmap.png")
```

---

### Shooter and Goalie variance
...
```{r}
mean(((all_loso_cv_preds2$outcome_type=="Goal")-all_loso_cv_preds2$Goal)^2)+
mean(((all_loso_cv_preds2$outcome_type=="Rebound")-all_loso_cv_preds2$Rebound)^2)+
mean(((all_loso_cv_preds2$outcome_type=="GoalieFroze")-all_loso_cv_preds2$GoalieFroze)^2)+
mean(((all_loso_cv_preds2$outcome_type=="PlayInZone")-all_loso_cv_preds2$PlayInZone)^2)+
mean(((all_loso_cv_preds2$outcome_type=="Stop")-all_loso_cv_preds2$Stop)^2)+
mean(((all_loso_cv_preds2$outcome_type=="PlayOutsideZone")-all_loso_cv_preds2$PlayOutsideZone)^2)
```
...
* Can look at specific players and goalies and predict their shot outcomes

--

* We are looking at more than just Expected Goals - we are including other outcomes that could occur from a shot
